...
module AuthenticatedSystem
  ...
  #  end
  #
  def authorized?(_action = action_name, _resource = nil)
    logged_in?
  end
  ...
  def handle_remember_cookie!(new_cookie_flag)
    ...
    if valid_remember_cookie? then @current_user.refresh_token # keeping same expiry date
    elsif new_cookie_flag then @current_user.remember_me
