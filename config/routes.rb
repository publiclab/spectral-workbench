SpectralWorkbench::Application.routes.draw do
  ...
  post 'macros/update' => 'macros#update'
  patch 'macros/update' => 'macros#update'
  get 'macros/index' => 'macros#index' 
  delete 'macros/delete' => 'macros#delete' 
  post 'macros/new' => 'macros#new' 
  ...
  post 'sets/new' => 'sets#new' 
  get 'sets/edit' => 'sets#edit' 
  post 'sets/create' => 'sets#create' 
  ...
  post 'spectrums/new' => 'spectrums#new' 
  get 'spectrums/edit' => 'spectrums#edit' 
  delete 'spectrums/destroy' => 'spectrums#destroy' 
  post 'spectrums/create' => 'spectrums#create' 
  ...
  post 'spectrums/save' => 'spectrums#save' 
  ...
  post 'capture/save/:id' => 'capture#save' 
  get 'capture/index/:id' => 'capture#index' 
  post 'comments/spectraset/:id' => 'comments#spectraset' 
  get 'comments/delete/:id' => 'comments#delete' # get route used to delete comments
  post 'comments/spectrum/:id' => 'comments#spectrum' 
  ...
  delete 'likes/delete/:id' => 'likes#delete' 
  ...
  post 'macros/create/:id' => 'macros#create' 
  get 'macros/show/:id' => 'macros#show' 
  post 'macros/update/:id' => 'macros#update' 
  get 'macros/index/:id' => 'macros#index' 
  delete 'macros/delete/:id' => 'macros#delete' 
  ...
  post 'sets/update/:id' => 'sets#update' 
  ...
  delete 'sets/delete/:id' => 'sets#delete' 
  get 'sets/add/:id' => 'sets#add' 
  post 'sets/new/:id' => 'sets#new' 
  ...
  post 'snapshots/create/:id' => 'snapshots#create' 
  ...
  post 'spectrums/new/:id' => 'spectrums#new' 
  get 'spectrums/edit/:id' => 'spectrums#edit' 
  get 'spectrums/destroy/:id' => 'spectrums#destroy' # get route used to destroy spectra
  post 'spectrums/create/:id' => 'spectrums#create' 
  ...
  post 'spectrums/save/:id' => 'spectrums#save' 
  ...
  post 'tags/create/:id' => 'tags#create' 
  ...
  post 'comments/spectraset/:id.:format' => 'comments#spectraset' 
  delete 'comments/delete/:id.:format' => 'comments#delete' 
  post 'comments/spectrum/:id.:format' => 'comments#spectrum' 
  ...
  delete 'likes/delete/:id.:format' => 'likes#delete' 
  ...
  post 'macros/create/:id.:format' => 'macros#create' 
  get 'macros/show/:id.:format' => 'macros#show' 
  post 'macros/update/:id.:format' => 'macros#update' 
  get 'macros/index/:id.:format' => 'macros#index' 
  delete 'macros/delete/:id.:format' => 'macros#delete' 
  post 'macros/new/:id.:format' => 'macros#new' 
  ...
  post 'snapshots/create/:id.:format' => 'snapshots#create' 
  ...
  post 'spectrums/save/:id.:format' => 'spectrums#save' 
  ...
  delete 'tags/destroy/:id.:format' => 'tags#destroy' 
  post 'tags/create/:id.:format' => 'tags#create' 
